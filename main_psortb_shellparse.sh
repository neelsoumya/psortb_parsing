...
do
	...
	then
		...
		# finally, paste all 3 files (a,n,p) together
                ...
                # syntax is python psortb_parser_v2.py 3496 '3496_psorta' '3496_psortb_output_parsed.txt'
                python psortb_parser_v2.py ${str_partition_array[0]} temp_file ${str_partition_array[0]}_psortb_parsed_output
...
# output header line
echo -e 'Partition_number\tProtein_id\tProtein_name\tLocalization_a\tScore_a\tLocalization_n\tScore_n\tLocalization_p\tScore_p' > FINAL_PSortB_parsed_file_secreted
